...
circle_ril1 = plt.Circle((0, 0), t1.raggio, fill=False, edgecolor='blue', linestyle='--', label='Circonferenza rivelatori')
...
circle_ril2 = plt.Circle((0, 0), t2.raggio, fill=False, edgecolor='blue', linestyle='--', label='Circonferenza rivelatori')
